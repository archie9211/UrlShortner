...
export async function handleRootRequest(request, env): Promise<Response> {
...
export async function deleteUrl(request, env): Promise<Response> {
  ...
  if (storedPassword && password === storedPassword) {
    ...
    return new Response("URL deleted successfully",
    { status: 200 });
  } else {
